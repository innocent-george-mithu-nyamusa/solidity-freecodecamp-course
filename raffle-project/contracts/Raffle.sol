// create contract Raffle

//Enter the lottery
//Pick a random winner
//winner will be selected every X minute -> completely automate
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /* 
    * @dev This is the function the chainlink keeper 
    * nodes call, they look for the upkeep Needed to return true
    */
    ...
    function fulfillRandomWords(uint256 /* RequestId */, uint256[] memory randomWords) internal override {
        ...
        //require sucess to confirm transaction went through
        if(!success) {
